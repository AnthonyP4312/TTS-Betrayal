alt_GUID = "56a70f" --GUID of the other Character choice
...
function tile_clicked(ob, color)
	if color == player_Color then
		...
		tokenBag.takeObject({position = {-10.10,3,29.56}})
		tokenBag.takeObject({position = {-9.10,3,33.19}})
		tokenBag.takeObject({position = {-13.61,3,29.52}})
		tokenBag.takeObject({position = {-14.68,3,33.14}})
	else
