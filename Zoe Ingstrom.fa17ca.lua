alt_GUID = "57723d" --GUID of the other Character choice
...
function tile_clicked(ob, color)
	if color == player_Color then
		...
		tokenBag.takeObject({position = {-47.472,3,-21.81}})
		tokenBag.takeObject({position = {-50.74,3,-20.70}})
		tokenBag.takeObject({position = {-47.643,3,-25.729}})
		tokenBag.takeObject({position = {-51.102,3,-26.432}})
	else
